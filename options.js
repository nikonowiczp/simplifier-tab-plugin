...
// Load existing rules
chrome.storage.sync.get(['rules','onlyUseWithRules','hideObjectType'], (data) => {
...
document.getElementById('save').addEventListener('click', () => {
    const rules = [];
    const onlyUseWithRules = document.getElementById('onlyUseWithRules').checked;
    const hideObjectType = document.getElementById('hideObjectType').checked;
    ...
    chrome.storage.sync.set({
        rules: rules,
        onlyUseWithRules: onlyUseWithRules,
        hideObjectType: hideObjectType,
    }, () => {
